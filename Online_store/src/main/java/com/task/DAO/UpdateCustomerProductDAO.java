...
public class UpdateCustomerProductDAO {
	...
	public int updateProduct(ProductBean bean, int reqNo) {
		...
		String query = "update product set PRODUCT_NAME = ?,PRODUCT_COMPANY =?,PRODUCT_PRICE =?, PRODUCT_QUANTITY = PRODUCT_QUANTITY - ? where PRODUCT_CODE = ?";
	...
	public boolean checkItems(ProductBean bean, int reqNo) {
		...
		String query = "select PRODUCT_QUANTITY from product where PRODUCT_CODE = ?";
